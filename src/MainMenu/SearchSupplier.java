...
public class SearchSupplier extends JFrame implements ActionListener
{
	...
	SearchSupplier()
	{
		...
		t1.setBounds(650,120,100,25);t1.setToolTipText("Enter supplier id to search supplier");
		jf.add(t1);
		...
		t2.setBounds(670,160,200,25);t2.setToolTipText("Enter supplier name to search supplier");
		jf.add(t2);
		...
		t3.setBounds(670,200,250,25);jf.add(t3);
		...
		t4.setBounds(670,240,100,25);jf.add(t4);
		...
		t5.setBounds(670,280,200,25);jf.add(t5);
		...
		b1.setBounds(650,330,110,35);b1.setToolTipText("click to clear all textfields");
	    jf.add(b1); b1.addActionListener(this);

        b2= new JButton("All",new ImageIcon("images//all.png"));
		b2.setBounds(800,330,110,35);b2.setToolTipText("click to view all supplier details");

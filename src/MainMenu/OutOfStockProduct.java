...
public class OutOfStockProduct  extends JFrame implements ActionListener
 {
    JFrame jf;
          ...
          while(rs.next())
            {
              ...
              if (foundrec == 0)
                {
                    JOptionPane.showMessageDialog(null,"Not any product out of stock on the  given date","Dialog",JOptionPane.WARNING_MESSAGE);
                }
	        }
             con.close();
       }

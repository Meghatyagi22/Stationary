...
public class DailySoldReport extends JFrame implements ActionListener
 {
    JFrame jf;
  ...
  public DailySoldReport()
  {
   ...
   jf.setLayout(null);
    ...
    t1.setToolTipText("Enter  product sold date");
    jf.add(t1);

    submit = new JButton("Submit");
    submit.setBounds(500,190,110,35); 
    submit.setToolTipText("click to open daily sold report");
    jf.add(submit);
	...
	if(ae.getSource()==submit)
     ...
     try
     {
	        ...
	        {
		    JOptionPane.showMessageDialog(this,"Please enter sold date !","Warning!!!",JOptionPane.WARNING_MESSAGE);
	        }
	        else
	        {
	         int foundrec = 0;
          ...
          while(rs.next())
            {
              ...
              if (foundrec == 0)
                {
                    JOptionPane.showMessageDialog(null,"Not any product sold on given date","Dialog",JOptionPane.WARNING_MESSAGE);
                }
	        }
             con.close();
       }

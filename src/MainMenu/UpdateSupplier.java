...
public class UpdateSupplier extends JFrame implements ActionListener
{
	...
	UpdateSupplier()
	{
		...
		t1.setBounds(700,120,100,25);t1.setToolTipText("Enter supplier id");
		jf.add(t1);
		...
		t2.setBounds(700,160,200,25);t2.setToolTipText("Enter supplier name");
		jf.add(t2);
		...
		t3.setBounds(700,200,250,25);t3.setToolTipText("Enter supplier address");
		jf.add(t3);
		...
		t4.setBounds(700,240,100,25);t4.setToolTipText("Enter supplier phone no");
		jf.add(t4);
		...
		t5.setBounds(700,280,200,25);t5.setToolTipText("Enter supplier emailid");
		jf.add(t5);


        b0 = new JButton("Open",new ImageIcon("images//open.png"));
	    b0.setBounds(500,330,110,35);b0.setToolTipText("click to open supplier details");
	    jf.add(b0); b0.addActionListener(this);

		b1 = new JButton("Update",new ImageIcon("images//update.png"));
		b1.setBounds(700,330,110,35);b1.setToolTipText("click to update supplier details");
		jf.add(b1);b1.addActionListener(this);

		b2 = new JButton("Clear",new ImageIcon("images//clear.png"));
		b2.setBounds(900,330,110,35);b2.setToolTipText("click to clear all textfilds");
	    jf.add(b2);b2.addActionListener(this);

	   	b3 = new JButton("All",new ImageIcon("images//all.png"));
		b3.setBounds(1100,330,110,35);b3.setToolTipText("click to view all supplier details");

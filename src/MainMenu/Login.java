...
class Login extends JFrame implements ActionListener
{
	...
	label.setBounds(0,0,1920,1020);
        ...
        l5 = new JLabel("login");
        l5.setFont(new Font("Algerian",Font.PLAIN,50));
        
        l5.setBounds(700,100,300,40);
       ...
       // jf.getContentPane().setBackground(Color.cyan);
		...
		l1.setBounds(600,200,200,25);
		jf.add(l1);

		t1 = new JTextField(20);
		t1.setBounds(750,200,200,25);
		...
		l2.setBounds(600,240,200,25);
		jf.add(l2);

		p1 = new JPasswordField(20);
		p1.setBounds(750,240,200,25);
		...
		b2.setBounds(725,300,100,35);
		jf.add(b2);
		b2.addActionListener(this);

		b3 = new JButton("Exit");
		b3.setBounds(850,300,100,35);
		jf.add(b3);
